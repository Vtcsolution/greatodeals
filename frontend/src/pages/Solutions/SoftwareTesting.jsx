...
import software_video from '../../assets/images/Services/software_design.mp4'
const SoftwareTesting = () => {
  ...
  const testimonials = [
    {
      text: "Greatodeal's QA team caught critical bugs early, saving us 30% in post-launch fixes and ensuring a smooth release.",
      name: "Sarah P.",
      role: "Product Manager, TechTrend",
      avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=64&h=64&fit=crop&crop=face"
    },
    {
      text: "Their automated testing suite reduced our testing time by 50%, allowing us to deploy faster with confidence.",
      name: "David L.",
      role: "CTO, InnovateApp",
      avatar: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=64&h=64&fit=crop&crop=face"
    },
    {
      text: "Comprehensive QA and usability testing ensured our software met industry standards and user expectations.",
      name: "Emma R.",
      role: "QA Lead, SecureSys",
  ...
  const benefits = [
    {
      ...
      description: "Comprehensive testing ensures your software is bug-free and reliable.",
      icon: Shield
    },
    {
      title: "Automation Efficiency",
      description: "Leverage automation to speed up testing and reduce human error.",
      icon: Zap
    },
    {
      title: "User-Centric QA",
      description: "Usability testing ensures intuitive and satisfying user experiences.",
      icon: Users
    },
    {
      title: "Compliance Assurance",
      description: "Meet industry standards like GDPR, HIPAA, and ISO with rigorous QA.",
      icon: CheckCircle
    },
    {
      title: "Scalable Processes",
      description: "Testing frameworks that scale with your software's growth.",
      icon: Layers
    }
  ];
  ...
  const industries = [
    {
      title: "Healthcare",
      description: "Ensure HIPAA-compliant, secure medical software",
      icon: "🏥"
    },
    {
      title: "Finance",
    ...
    {
      title: "E-Commerce",
      description: "Seamless shopping experiences across platforms",
      icon: "🛒"
    },
    {
      title: "Gaming",
      description: "Bug-free, immersive gaming experiences",
      icon: "🎮"
    },
    {
      title: "SaaS",
      description: "Scalable testing for cloud-based platforms",
      icon: "☁️"
    },
    {
      title: "Logistics",
      description: "Reliable tracking and management systems",
      icon: "🚛"
    }
  ];
  ...
  const services = [
    {
      title: "Test Planning",
      description: "Develop detailed test strategies and plans tailored to your project.",
      icon: Search
    },
    {
      title: "Manual Testing",
      description: "Execute in-depth manual tests for functionality and usability.",
      icon: CheckCircle
    },
    {
      title: "Automated Testing",
      description: "Implement automated scripts for efficiency and repeatability.",
      icon: Code
    },
    {
      title: "Performance Testing",
      description: "Assess system performance under various conditions.",
      icon: BarChart3
    },
    {
      title: "Security Testing",
      description: "Identify vulnerabilities to ensure data protection.",
      icon: Shield
    }
  ];

  const processSteps = [
    { number: "01", title: "Requirement Analysis", description: "Understand project goals and define testing scope." },
    { number: "02", title: "Test Strategy Design", description: "Create a comprehensive test plan with clear objectives." },
    { number: "03", title: "Test Case Development", description: "Design detailed test cases for all scenarios." },
    { number: "04", title: "Environment Setup", description: "Configure testing environments to mirror production." },
    { number: "05", title: "Test Execution", description: "Run manual and automated tests to identify issues." },
    { number: "06", title: "Bug Reporting", description: "Document and track defects for resolution." },
    { number: "07", title: "Regression Testing", description: "Ensure fixes don't introduce new issues." },
    { number: "08", title: "Performance Optimization", description: "Analyze and enhance system performance." },
    { number: "09", title: "Final Validation", description: "Verify software meets all requirements." },
    { number: "10", title: "Reporting & Insights", description: "Provide detailed test reports and metrics." },
    { number: "11", title: "Ongoing Support", description: "Offer continuous QA for updates and maintenance." }
  ];

  const techStack = [
    {
      category: "Testing Frameworks",
      technologies: ["Selenium", "Cypress", "TestNG"],
      icon: Code
    },
    {
      category: "Performance Tools",
      technologies: ["JMeter", "LoadRunner", "Gatling"],
      icon: BarChart3
    },
    {
    ...
    },
    {
      ...
      technologies: ["JIRA", "TestRail", "Zephyr"],
      icon: Database
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "We provide functional, performance, security, usability, regression, and more."
    },
    {
      question: "How does automated testing benefit my project?",
      answer: "Automation speeds up testing, improves accuracy, and reduces costs."
    },
    {
      question: "What is the timeline for a QA project?",
      answer: "Typically 2-8 weeks, depending on complexity and scope."
    },
    {
      question: "Do you test for accessibility?",
      answer: "Yes, we ensure compliance with WCAG standards."
    },
    {
      question: "Can you test existing software?",
      answer: "Absolutely, we offer audits and testing for legacy systems."
    },
    {
      question: "How do you ensure security in testing?",
      answer: "We use tools like OWASP ZAP and follow best practices."
    }
  ];
...
We design and develop custom software solutions precisely tailored to your business goals. Combining modern technologies, cloud-ready architectures, and secure engineering practices, our software delivers scalability, reliability, and high performance. </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 text-[#E5E7EB]">
              Why Choose Greatodeal for Software Testing & QA
            </h2>
          </div>
      ...
      {/* Solutions Section */}
      <section id="solutions" className="py-20 bg-[#0D0D0D]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <div className="text-center mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 text-[#E5E7EB]">
            ...
            <p className="text-center text-base sm:text-lg text-[#9CA3AF] max-w-4xl mx-auto">
              Our QA services ensure your software is robust, secure, and user-friendly across platforms.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-base sm:text-lg text-[#9CA3AF] max-w-3xl mx-auto">
              From planning to execution, we ensure your software meets the highest quality standards.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                      ...
                      >
                        <div className="pt-4 border-t border-[#374151]/50">
                          ...
                          <p className="text-xs sm:text-sm text-[#9CA3AF] leading-relaxed mb-3">
                            Detailed testing methodologies to ensure quality and performance.
                          </p>
                          <Link
                            to="/contact"
            ...
            <div className="relative order-first lg:order-last">
              <img
                src="https://images.unsplash.com/photo-1611162617210-7d673bf0f2a8?w=600&h=600&fit=crop"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-[#9CA3AF] max-w-4xl mx-auto animate-fade-in-up" style={{animationDelay: '0.4s'}}>
              A systematic approach to deliver high-quality, reliable software.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {processSteps.map((step, index) => (
              ...
              >
                <div className="bg-gradient-to-br from-[#1A1A1A] via-[#1A1A1A] to-[#1A1A1A] p-6 sm:p-8 rounded-2xl h-full relative overflow-hidden border border-[#374151]/50 hover:border-[#6EE7B7]/40 transition-all duration-500 hover:shadow-2xl hover:shadow-[#6EE7B7]/20 hover:transform hover:scale-105 hover:-translate-y-2">
                  ...
                  {index < processSteps.length - 1 && (
                    <div className="hidden lg:block absolute -right-4 top-1/2 transform -translate-y-1/2 z-20 animate-pulse">
                      <div className="bg-[#1A1A1A] rounded-full p-2 border border-[#374151] transition-all duration-300 hover:border-[#6EE7B7] hover:bg-[#1A1A1A] hover:shadow-lg hover:shadow-[#6EE7B7]/30">
      ...
      {/* Technology Section */}
      <section id="technology" className="py-20 bg-[#0D0D0D]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold mb-6 text-[#E5E7EB]">
              Tools for Robust Testing & QA
            </h2>
            <p className="text-base sm:text-lg text-[#9CA3AF] max-w-4xl mx-auto">
              Industry-leading tools to ensure quality and performance.
            </p>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D] overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold text-[#E5E7EB] mb-8">
              ...
              >
                Ensure flawless software with Greatodeal's QA.
              </motion.span>
              <br />
              <motion.span
                className="inline-block"
