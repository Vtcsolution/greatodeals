...
import investvideo from '../../assets/images/Industries/investments.mp4'
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
            <Link to="/contact" className="bg-gradient-to-r from-[#2E7D7B] to-[#4CAF50] hover:from-[#266966] hover:to-[#43A047] text-[#F5F6F5] px-8 py-4 rounded-lg font-semibold transition-all duration-300 shadow-lg inline-block">
              Get in Touch
            </Link>
          </motion.div>
        </div>
