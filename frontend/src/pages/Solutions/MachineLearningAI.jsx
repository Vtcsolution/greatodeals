...
import Artificial_Intelligence_Brain from '../../assets/images/Services/Artificial_Intelligence_Brain.mp4'
import machine_learning from '../../assets/images/Services/machine_learning.jpg'
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-full h-[300px] sm:h-[400px] lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                <video
                  ...
                  src={Artificial_Intelligence_Brain}
