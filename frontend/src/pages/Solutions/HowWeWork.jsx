            ...
            >
              <div className="relative w-full max-w-lg lg:max-w-full h-[400px] sm:h-[500px] lg:h-[600px] rounded-3xl overflow-hidden shadow-2xl border-4 border-[#6EE7B7]/20">
                <video
                  ...
                  src="https://videos.pexels.com/video-files/2020109/2020109-hd_1920_1080_30fps.mp4"
                  poster="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&h=600&fit=crop"
                >
                  Your browser does not support the video tag.
                </video>
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0F1E]/60 via-transparent to-transparent"></div>
                
                {/* Floating stats */}
                <div className="absolute bottom-8 left-8 right-8 flex flex-wrap gap-4">
                  <div className="bg-[#1E1E1E]/90 backdrop-blur-lg px-6 py-3 rounded-xl border border-[#6EE7B7]/30">
                    <div className="text-2xl font-bold text-[#6EE7B7]">3-6 Months</div>
                    <div className="text-xs text-[#9CA3AF]">Average Timeline</div>
                  </div>
                  <div className="bg-[#1E1E1E]/90 backdrop-blur-lg px-6 py-3 rounded-xl border border-[#3B82F6]/30">
                    <div className="text-2xl font-bold text-[#3B82F6]">6 Phases</div>
                    <div className="text-xs text-[#9CA3AF]">Proven Process</div>
                  </div>
                </div>
              </div>
            </motion.div>
